...
INSERT INTO notice_details (notice_summary, notice_details, notic_beg_dt, notic_end_dt, create_dt, update_dt)
VALUES ('Mobile App Downtime', 'The mobile application will be down from 2AM-5AM on 12/05/2020 due to maintenance activities', DATEADD('DAY', -30, CURRENT_DATE), DATEADD('DAY', 30, CURRENT_DATE), CURRENT_DATE, NULL);
...
INSERT INTO notice_details (notice_summary, notice_details, notic_beg_dt, notic_end_dt, create_dt, update_dt)
VALUES ('Launch of Millennia Cards', 'Millennia Credit Cards are launched for the premium customers', DATEADD('DAY', -30, CURRENT_DATE), DATEADD('DAY', 30, CURRENT_DATE), CURRENT_DATE, NULL);
